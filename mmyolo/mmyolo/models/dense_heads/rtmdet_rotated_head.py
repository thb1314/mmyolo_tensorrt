...
class RTMDetRotatedHead(RTMDetHead):
    ...
    def predict_by_feat(self,
        ...
        # print(self.angle_coder.decode.__code__)
        flatten_angle_preds = self.angle_coder.decode(
            flatten_angle_preds, keepdim=True)
        torch.save(flatten_cls_scores, 'scores.pkl')
        print('flatten_cls_scores.shape', flatten_cls_scores.shape)
        print('flatten_cls_scores', flatten_cls_scores)
        
        print("max(flatten_cls_scores)", flatten_cls_scores.max(), flatten_cls_scores.view(-1).argmax())
        ...
        # print('with_objectnesses', with_objectnesses)
        # print('decode_with_angle', decode_with_angle)
        # print('self.bbox_coder.decode.__code__', self.bbox_coder.decode.__code__)
