...
namespace
{
const char* EFFICIENT_NMS_ROTATED_PLUGIN_VERSION{"1"};
const char* EFFICIENT_NMS_ROTATED_PLUGIN_NAME{"EfficientNMS_TRT_ForRotateBox"};
const char* EFFICIENT_NMS_ONNX_ROTATED_PLUGIN_VERSION{"1"};
const char* EFFICIENT_NMS_ONNX_ROTATED_PLUGIN_NAME{"EfficientNMS_ONNX_TRT_ForRotateBox"};
} // namespace
...
{
    return EFFICIENT_NMS_ROTATED_PLUGIN_NAME;
}

const char* EfficientNMSPlugin::getPluginVersion() const noexcept
{
    return EFFICIENT_NMS_ROTATED_PLUGIN_VERSION;
}
...
{
    return EFFICIENT_NMS_ONNX_ROTATED_PLUGIN_NAME;
}

const char* EfficientNMSONNXPluginCreator::getPluginVersion() const noexcept
{
    return EFFICIENT_NMS_ONNX_ROTATED_PLUGIN_VERSION;
}
...
REGISTER_TENSORRT_PLUGIN(EfficientNMSONNXPluginCreator);
